  ...
  useEffect(() => {
    db.collection("products")
      ...
      .then((snapshot) => {
        ...
        setProductName((name) => (name = product[0].product.name));
        setProductPrice((price) => (price = product[0].product.startingFrom));
        setproductShortDesc(
          (shortDesc) => (shortDesc = product[0].product.shortDesc)
        );
      })
    ...
    <div className={"product-details"}>
...

      {
        ...
        <div className="product-price">
          <span className="out-price">{productPrice}</span>
        </div>
      ) : 0 < product.discount ? (
        <div className="product-price">
